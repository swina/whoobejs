<template>
    <div :data="init" class="p-2 theme-dark h-screen">
        <!-- material icons -->
        <div v-if="editor.current.tag==='icon'" class="flex flex-col">
            Material Icons
            <i class="material-icons m-auto p-2 border" v-if="editor.current.content">{{ editor.current.content }}</i>
        ...
        <!-- bootstrap icons -->
        <div v-if="editor.current.tag === 'icon_bt'" class="flex flex-col">
            Bootstrap Icons
