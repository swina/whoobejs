<template>
    <div 
        ...
        :class="'content-slider max-w-screen overflow-x-hidden h-full flex flex-no-wrap block ' + classe(doc.css)" :style="doc.style + ' ' +  background(doc)" :ref="doc.id">
            ...
            <div v-if="doc.controls.dots.enable" class="absolute bottom-0 left-0 text-center flex-row justify-center items-center p-1 w-full">
...
import MokaPreviewContainer from './moka.slider.container'
