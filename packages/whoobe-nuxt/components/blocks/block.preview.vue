<template> 
    <div :key="refreshID" :ref="doc.id" :class="pageCss(doc.css) + ' m-auto relative overflow-y-auto  overflow-x-hidden '" :style="stile(doc)" id="content">
...
export default {
    ...
    props: [ 'doc' ],
    components: {
        //'block-preview-container'           : () => import ( './block.preview.container.vue') ,
    },
    metaInfo(){
        return  {
