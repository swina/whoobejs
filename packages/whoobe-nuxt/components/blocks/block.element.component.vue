    ...
    computed:{
        component(){
            ...
            if ( el.tag === 'article' && el.element != 'img' ){
                ...
                el.content = this.$attrs.article[el.label]//this.$store.state.whoobe.article[el.label]
                return MokaText
            }
            if ( el.tag === 'article' && el.element === 'img' ){
                el.image = this.$attrs.article[el.label]//this.$store.state.whoobe.article[el.label]
                return MokaImg
            }
